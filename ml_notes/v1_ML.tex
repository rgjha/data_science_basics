...
Matrix Factorization are part of \rmph{latent factor models}. These compress user-item matrix into a low-dimensional representation in terms of latent factors. 
