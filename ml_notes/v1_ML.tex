...
\begin{itemize} 
\item Is Spark needed or Pandas is enough. Seems like threshold of memory consumption is 10-12 Gb. 
\item What level of SQL is needed beyond simple queries 
\item Ask about why mlflow is needed and good reference -- Ask about data pipeline (Scikit-learn)?
